      ...
      <svg className="absolute inset-0 h-full w-full overflow-visible" viewBox="0 0 100 100" aria-hidden="true">
        <defs>
          <radialGradient id="techRadarGlow" cx="50%" cy="50%" r="52%">
            <stop offset="0%" stopColor="#f4b64b" stopOpacity="0.14" />
            <stop offset="72%" stopColor="#f4b64b" stopOpacity="0.03" />
          ...
          <linearGradient id="techRadarFill" x1="15%" x2="90%" y1="15%" y2="92%">
            ...
            <stop offset="1" stopColor="#f4b64b" stopOpacity="0.06" />
          </linearGradient>
          <filter id="nodeGlow">
        ...
        <polygon points={techRadarPolygon} fill="url(#techRadarFill)" stroke="#f4b64b" strokeWidth="0.7" filter="url(#nodeGlow)" />
