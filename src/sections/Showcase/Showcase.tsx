                  ...
                  >
                    ...
                    <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                      <button
                        ...
                        className="inline-flex min-h-10 items-center justify-center gap-2 rounded-lg border border-white/12 bg-white/[0.03] px-4 font-mono text-xs font-bold uppercase tracking-widest text-white/60 transition hover:border-[#f4b64b]/50 hover:bg-[#f4b64b]/8 hover:text-[#f4b64b]"
                      >
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex min-h-10 items-center justify-center gap-3 font-mono text-xs font-bold uppercase tracking-widest text-[#f4b64b] transition hover:translate-x-1 hover:text-white sm:justify-end"
                      >
