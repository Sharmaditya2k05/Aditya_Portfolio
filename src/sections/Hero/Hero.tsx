  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute bottom-0 inset-x-0 z-[2] h-48"
        style={{ background: "linear-gradient(to bottom, transparent 0%, rgba(12,12,12,0.6) 50%, #0C0C0C 100%)" }} />
      ...
      <div className="relative z-10 flex flex-1 flex-col">
        ...
        <div className="mt-auto flex items-end justify-between px-10 pb-10">
          ...
          <motion.a
            ...
            className="flex items-center gap-2.5 rounded-full px-6 py-3 font-mono text-xs font-semibold uppercase tracking-widest text-white/70 transition-all duration-300 hover:text-white hover:-translate-y-0.5"
            style={{
