...
export const STATS: DeveloperStat[] = [
  { icon: "◈", value: "3+", label: "Projects Completed", sub: "Production-grade AI systems" },
  { icon: "◎", value: "5+", label: "AI/ML Models Built", sub: "CNNs, KNN, Deep Learning" },
  { icon: "◆", value: "4+", label: "Certifications", sub: "Google, HackerRank, IIT BHU" },
  { icon: "◉", value: "500+", label: "Hours Coded", sub: "Python, C++, TensorFlow" },
];
