...
export const PROJECTS: ShowcaseProject[] = [
  ...
  },
  {
    ...
    title: "NutriLens AI",
    subtitle: "AI-Powered Nutrition Intelligence & Food Analysis Platform",
    desc: "Next-gen food intelligence platform combining RAG + Google Gemini AI, barcode scanning, ingredient red-flag detection, Nutri-Score/NOVA grading, and personalized diet plans. React + Vite frontend with FastAPI backend and custom ML models.",
    tags: ["React", "Vite", "FastAPI", "Google Gemini", "RAG", "scikit-learn", "Python"],
    stats: [
      { value: "RAG", label: "AI Architecture" },
      { value: "5+", label: "ML Models" },
      { value: "Real-time", label: "Analysis" },
    ],
    href: "https://github.com/Sharmaditya2k05/NutriLensAI",
    period: "Jul 2026 - Present",
    longDesc: `NutriLens AI v2 is a next-generation, AI-powered food intelligence platform designed to empower users with comprehensive nutritional transparency. By combining modern ML models, Retrieval-Augmented Generation (RAG) with Google Gemini, and comprehensive food product data, NutriLens AI decodes complex ingredient labels into actionable health insights.\n\n## Key Features\n- Smart Food Product & Barcode Lookup\n- Ingredient & Health Analysis with red-flag detection\n- Standardized Health Grading (Nutri-Score & NOVA)\n- RAG + Google Gemini AI Insights\n- Custom ML Classification Models\n- Personalized Diet Plan Generation\n\n## Architecture\nUser → React + Vite Frontend → FastAPI Backend → Gemini AI + RAG Pipeline → ML Models → Health Insights`,
    techDetails: [
      { layer: "Frontend", tech: "React + Vite, TypeScript" },
      { layer: "Backend", tech: "FastAPI, Python" },
      { layer: "AI/LLM", tech: "Google Gemini, RAG Pipeline" },
      { layer: "ML", tech: "scikit-learn, Custom classifiers" },
    ],
    features: [
      "Smart food product & barcode scanning lookup",
      "Ingredient red-flag & controversial additive detection",
      "Nutri-Score color grading & NOVA processing classification",
      "RAG-powered Gemini AI contextual health explanations",
      "Custom ML classification & model comparison",
...
>[] = [
  ...
  },
  {
    ...
    title: "NutriLens AI",
    description:
      "AI-powered nutrition intelligence platform with RAG + Google Gemini AI, barcode scanning, ingredient red-flag detection, Nutri-Score/NOVA grading, and personalized diet plans. React + Vite frontend with FastAPI backend.",
    techStack: ["React", "Vite", "FastAPI", "Google Gemini", "RAG", "scikit-learn", "Python"],
    githubUrl: "https://github.com/Sharmaditya2k05/NutriLensAI",
    liveUrl: null,
    order: 4,
  },
];

export const FILTERS = ["All", "AI / Computer Vision", "Android / Algorithms", "Embedded AI", "DAA / Systems", "AI / Full-Stack"] as const;
