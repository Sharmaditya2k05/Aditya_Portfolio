...
export const PROJECTS: ShowcaseProject[] = [
  {
    ...
    desc: "Full-stack Android application analysing vehicle health using OBD data and computer vision. AI models detect mechanical faults with 85% accuracy, estimate repair costs from real-time data, and flag resale fraud across 50,000+ vehicle records.",
    tags: ["Android (Java)", "FastAPI", "SQLite", "OpenCV", "Deep Learning", "MVVM"],
    stats: [
  ...
  },
  {
    ...
    desc: "C++ simulation engine using Queue data structures to model intersections. Benchmarked Fixed-Time O(N), Greedy O(N²), and Priority Queue O(N log N) scheduling. Python/Streamlit frontend with real-time Plotly visualisations and Docker support.",
    tags: ["C++17", "Python", "Streamlit", "Plotly", "Priority Queue", "Docker"],
    stats: [
      { value: "3", label: "Algorithms" },
      { value: "O(N log N)", label: "Best case" },
      { value: "Real-time", label: "Visualisation" },
    ],
  ...
  },
  {
    ...
    desc: "AI-based system detecting people trapped under debris with 92% success rate in simulated scenarios. ML models monitor vital signs (pulse, O₂, CO₂) for real-time survivor detection. Computer vision in low-light conditions for human presence identification.",
...
>[] = [
  ...
  },
  {
    ...
    title: "Traffic Signal Analyzer",
    description:
      "End-to-end traffic intersection simulation demonstrating DAA concepts. Fixed-Time O(N), Greedy O(N²), and Priority Queue O(N log N) scheduling with Prefix Sum analytics. C++ engine + Streamlit frontend with 3D Plotly visualizations.",
